            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Testimonial</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="addtestimo.php" class="btn btn-primary">Add Testimonial <i
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        $sql = "SELECT * FROM testimonial ORDER BY testimonial.id ASC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <!-- <td class="text-right">
                                                    <div class="actions">
                                                        <a href="editservices.php?id=<?php echo $row["id"] ?>"
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        ...
                                                        <a href="deletetestimo.php?id=<?php echo  $row["id"] ?>"
