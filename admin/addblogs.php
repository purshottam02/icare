            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Add Blogs</h3>
                            <ul class="breadcrumb">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="textarea" name="heading" class="form-control" required>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="descriptionnnn" class="form-control" rows="6"
                                                    required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="feature" class="form-control" rows="6"
                                                    required></textarea>
                                            </div>
                                        </div> -->
