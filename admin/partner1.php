...
<head>
    ...
    <link rel="shortcut icon" href="../images/resources/logo.png">
    <link rel="stylesheet"
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">Add Partners</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="addpartner1.php" class="btn btn-primary">Add Partners <i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-hover table-center mb-0 datatable">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        <a href="editpartner1.php?id=<?php echo $row["id"] ?>"
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        ...
                                                        <a href="deletepartner1.php?id=<?php echo  $row["id"] ?>"
