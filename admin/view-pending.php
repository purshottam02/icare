            ...
            <div class="content container-fluid">
                <div class="page-header" style="background: aliceblue; padding: 16px 29px; border-radius: 5px;">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">Pending Customers</h3>
                            <ul class="breadcrumb">
                            ...
                            <div class="card-body" style="padding: 0px;">
                                ...
                                <div class="table-responsive">
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <button class="btn btn-primary" onclick="exportTableToExcel('tblData', 'Pending_Customers')">Export to Excel</button>
                                    </div>
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM customers WHERE repair_status = 'Pending'
                                            AND shop_id = '$id'
