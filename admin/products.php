            ...
            <div class="content container-fluid">
                <div class="page-header" style="background: aliceblue; padding: 16px 29px; border-radius: 5px;">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Shop</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="addshop.php" class="btn btn-primary">Add Shop <i class="fas fa-plus"></i></a>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * FROM addshop ORDER BY addshop.id DESC";
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["services_offered"]; ?></td>
                                                        <td><?php echo $row["Website"]; ?></td>
                                                        <td><?php echo $row["media_link"]; ?></td>
                                                        <td><?php echo $row["registration_number"]; ?></td>
                                                        <td><?php echo $row["GST_number"]; ?></td>
                                                        <td><?php echo $row["shop_discription"]; ?></td>
                                                        <td><?php echo $row["service_warranty_period"]; ?></td>
                                                        <td><?php echo $row["payment_medhot"]; ?></td>
                                                        <td><?php echo $row["customer_support_number"]; ?></td>
                                                        <td><?php echo $row["shop_policies"]; ?></td>
                                                        <td><?php echo $row["shop_map_location"]; ?></td> -->
                                                        ...
                                                        <td class="text-right">
                                                            <div class="actions">
                                                                <a href="view-more.php?id=<?php echo $row["id"]; ?>"
                                                        ...
                                                        <!--<td class="text-right">-->
                                                        <!--    <div class="actions">-->
                                                        <!--        <a href="editproducts.php?id=<?php// echo $row["id"]; ?>"-->
                                                        <!--            class="btn btn-md bg-success-light">-->
                                                        ...
                                                        <!--<td class="text-right">-->
                                                        <!--    <div class="actions">-->
                                                        <!--        <a href="deleteproducts.php?id=<?php// echo $row["id"]; ?>"-->
                                                        ...
                                                        <td class="text-right">
                                                            <div class="actions">
                                                                <a href="view-cus.php?id=<?php echo $row["id"]; ?>"
                                                                    class="btn btn-md bg-success-light">
