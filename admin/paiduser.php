      ...
      <div class="content container-fluid">
        <div class="page-header">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="page-title">Paid User</h3>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                <li class="breadcrumb-item active">Paid User</li>
              </ul>
            </div>
              ...
              <div class="card ">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover table-center mb-0 " id="tblData">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM `userdata` INNER JOIN payment ON userdata.userdataid = payment.uid WHERE payment.payment_status='complete'";
                        ...
                        ?>
                            <tr>
                              ...
                              <td class="text-right">
                                <div class="actions">
                                  <!--  <a href="userdetail.php?id=<?php //echo  $row["user_Id"] 
