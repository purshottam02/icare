                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="num" value="<?php echo $row['contact_number']; ?>" required>
                                            </div>
                                            <!-- <div class="form-group">
                                                <label>Description</label>

                                                <textarea type="text" style="height:222px;" class="form-control" name="message" required><?php echo $row['description']; ?></textarea>
                                            </div> -->
                                        </div>

                                        <!--div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    <label>Welcome Description 2</label>
