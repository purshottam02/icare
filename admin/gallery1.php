            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">Add Images</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="addgallery1.php" class="btn btn-primary">Add Images <i class="fas fa-plus"></i></a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        ...
                                                        <a href="deletegallery1.php?id=<?php echo  $row["id"] ?>"
