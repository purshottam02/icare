            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Add Partners</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="partner1.php">Partners</a></li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="insertpartner1.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12">
