            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Achievements</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Achievements</a></li>
                                <li class="breadcrumb-item active">All Achievements</li>
                            </ul>
                        </div>
                        <!--<div class="col-auto text-right float-right ml-auto">-->
                        <!--     <a class="btn btn-primary" onclick="exportTableToExcel('tblData')">Download</a> -->
                        <!--    <a href="addachiev.php" class="btn btn-primary">Add Achievements <i-->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        $sql = "SELECT * FROM acheive ORDER BY acheive.id ASC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        <a href="editachiev.php?id=<?php echo $row["id"] ?>"
