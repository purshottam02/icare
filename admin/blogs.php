            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">All Blogs</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="addblogs.php" class="btn btn-primary">Add Blogs <i
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        $sql = "SELECT * FROM blogs ORDER BY blogs.id ASC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <!-- <td class="text-right">
                                                    <div class="actions">
                                                        <a href="editblogs.php?id=<?php echo $row["id"] ?>"
                                                ...
                                                <td class="text-right">
                                                    <div class="actions">
                                                        ...
                                                        <a href="deleteblogs.php?id=<?php echo  $row["id"] ?>"
