                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-right float-right ml-auto">
                            ...
                            <a href="add_gallery.php" class="btn btn-primary" style="font-family: system-ui;">Add Gallery</a>
                        </div>
                    </div>
                </div>
                                                ...
                                                while ($row = $result->fetch_assoc()) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form method="POST" action="eg.php" enctype="multipart/form-data">
                                                            <td><label for="files"><img src="<?php echo $row["img"] ?>" width="50%"></label><br><input type="file" id="files" name="bimg" style="display:none;" /></td>
                                                        ...
                                                        <a href="deletgallery.php?id=<?php echo $row["id"] ?>" onclick='ConfirmDelete()' class="btn btn-sm bg-danger-light">
