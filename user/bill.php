            ...
            <div class="content container-fluid">
                ...
                <div class="container">
                    ...
                    ?>
                        ...
                        <tr>
                            <td colspan="8" style="    padding: 15px 5px;"><?php echo htmlspecialchars($customer["condition_of_device"]); ?></td>
                        </tr>
                    ...
                    *The Service Provider will not be responsible for any data loss, screen guard, wear and tear, and no
                    ...
                    <div class="col-12 text-center">
                        <button name="mail" type="button" class="btn btn-primary"> <a href="mailbill.php?id=<?= $id ?>&&email=<?= $email ?>">Send
                                Invoice</a></button>
                    </div>
                    <!-- CSS for print -->
                    <style>
