                            ...
                            <div class="card-body">
                                <form action="a.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        // Fetch all accessories data ordered by customer_id
                                        $sql = "SELECT * FROM accessories where customer_id = '$id' ";
                                        $result = $conn->query($sql);

                                        if ($result->num_rows > 0) {
                                            $srno = 1;
                                            // Display the static "Regular usage marks..." paragraph once, outside the loop
                                            ?>
                                            <?php

                                            // Loop through the fetched data and display accessories
                                            while ($row = $result->fetch_assoc()) {
                                                ?>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label>Accessories:</label>
                                                        <input name="accessories[]" class="form-control" required
                                                            value="<?php echo htmlspecialchars($row["accessories"]); ?>"></input>
                                                    </div>
                                                </div>
                                                <?php
                                                $srno++;
                                        ...
                                        <!-- Additional Problem Descriptions -->
                                        <div id="additional-accessories" class="col-12 col-sm-6"></div>

                                        <!-- Button to Add More Problem Descriptions -->
                                        <div class="col-12 col-sm-6">
                                            <button type="button" id="add-accessories" class="btn btn-primary">Add More
                                                Accessories</button>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="device_powering" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['device_powering']; ?>" selected>
                                                        <?php echo $row['device_powering']; ?>
                                                    </option>
                                                    <!-- Add other possible repair status options -->
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="power_button" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['power_button']; ?>" selected>
                                                        <?php echo $row['power_button']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="volume_keys" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['volume_keys']; ?>" selected>
                                                        <?php echo $row['volume_keys']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="display_working" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['display_working']; ?>" selected>
                                                        <?php echo $row['display_working']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="touchscreen" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['touchscreen']; ?>" selected>
                                                        <?php echo $row['touchscreen']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="speaker_working" class="form-control">
                                                    <!-- Show the current repair status as the selected option -->
                                                    <option value="<?php echo $row['speaker_working']; ?>" selected>
                                                        <?php echo $row['speaker_working']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="charging_port" class="form-control">
                                                    <option value="<?php echo $row['charging_port']; ?>" selected>
                                                        <?php echo $row['charging_port']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="headphone_jack" class="form-control">
                                                    <option value="<?php echo $row['headphone_jack']; ?>" selected>
                                                        <?php echo $row['headphone_jack']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="back_cover" class="form-control">
                                                    <option value="<?php echo $row['back_cover']; ?>" selected>
                                                        <?php echo $row['back_cover']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="body_damage" class="form-control">
                                                    <option value="<?php echo $row['body_damage']; ?>" selected>
                                                        <?php echo $row['body_damage']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="screw_head" class="form-control">
                                                    <option value="<?php echo $row['screw_head']; ?>" selected>
                                                        <?php echo $row['screw_head']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="sim_tray" class="form-control">
                                                    <option value="<?php echo $row['sim_tray']; ?>" selected>
                                                        <?php echo $row['sim_tray']; ?>
                                                    </option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
