...
<div class="container">
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><?php echo htmlspecialchars($customer["face_id"]); ?></td>
        ...
        <p style="font-weight: 600; margin-top:30px;">Terms and Conditions:</p>
        <p style="font-size: 12px;"> *Subject to Engineer’s inspection.<br>
