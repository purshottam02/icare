            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title" style="text-align: center; font-size: 41px; font-weight: 600;">Customer Reciept</h3>
                            <ul class="breadcrumb">
                ...
                <div class="container">
                    ...
                    <table>
                        <tr>
                            ...
                            ?>
                                    <!-- <th colspan="2"> <img src="../admin/image/<?php echo $row["image"]; ?>" alt="Logo"
                                            style="width: 11%;">
                                    </th> -->
                                    <th colspan="2" style="font-size: 44px; font-weight: 100;">ivenus</th>
                                    <th colspan="3" style="font-size: 22px; font-weight: 600;">Authorised Service Provider
                                        Details</th>
                        ...
                        <tr>
                            ...
                            <td class="barcode"><?php echo htmlspecialchars($customer["reference"]); ?></td>
                            <td rowspan="4" colspan="5">
                                <span style="font-weight: 600;">Owner Name: </span>
                                <?php echo htmlspecialchars($row["ownername"]); ?><br><br>
                        ...
                        <tr>
                            <td style="font-weight: 600;">Serial Number:</td>
                            <td class="barcode"><?php echo htmlspecialchars($customer["serialno"]); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <!-- <td colspan="3" class="section-title" style="font-size: 20px; font-weight: 600;     background: #f9f9f9;"> -->
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="1" class="section-title" style="font-size: 20px; font-weight: 600;">Checklist
                            </td>
                            <td colspan="1" class="section-title" style="font-size: 20px; font-weight: 600;">Inward Check
                            </td>
                        ...
                        <tr>
                            <td colspan="2" class="section-title" style="font-size: 20px; font-weight: 600;">Customer
                                Details</td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 600;">Display is Working</td>
                            <td><?php echo htmlspecialchars($customer["display_working"]); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="section-title" style="font-size: 20px; font-weight: 600;">Product
                                Details</td>
...
<tr>
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($fetched_value == 'Warranty') : ?>
                                            <td class="checkbox-button">
                                                <label for="warranty" class="gray-text">Warranty</label>
                                            </td>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($fetched_value == 'App') : ?>
                                            <td class="checkbox-button">
                                                <label for="app" class="gray-text">App</label>
                                            </td>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($fetched_value == 'OOW') : ?>
                                            <td class="checkbox-button">
                                                <label for="oow" class="gray-text">OOW</label>
                                            </td>
                                        <?php endif; ?>
                                        ...
                                        <?php if ($fetched_value == 'Others') : ?>
                                            <td class="checkbox-button">
                                                <label for="others" class="gray-text">Others</label>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                </table>
                            ...
                            <td style="font-weight: 600;">Headphone Jack is Working</td>
                            <td><?php echo htmlspecialchars($customer["headphone_jack"]); ?></td>
                        ...
                        <tr>
                            ...
                            <td style="font-weight: 600;">Back Cover Damaged or Broken</td>
                            <td><?php echo htmlspecialchars($customer["back_cover"]); ?></td>
                        </tr>
                        <tr>
                            <td style="font-weight: 600;"></td>
                            <td></td>
                            <td style="font-weight: 600;">Body is Damaged or has Dents</td>
                            <td><?php echo htmlspecialchars($customer["body_damage"]); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="section-title" style="font-size: 20px; font-weight: 600;">Issue
                                Reported by Customer</td>
                            <td style="font-weight: 600;">Screw Heads are Damaged or Missing</td>
                        ...
                        ?>
                         <tr>
                            <td colspan="2" class="section-title" style="font-size: 20px; font-weight: 600;">Cosmetic
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    if (!$staticTextDisplayed) {
                                        ...
                                        echo '<tr>
                        <td colspan="2">Regular usage marks, scratches, and dents on device; data loss; internal needs to be checked</td>
                        ...
                        <td colspan="3">' . htmlspecialchars($row["accessories"]) . '</td>
                                ...
                                echo "<tr><td colspan='5'>No Data In Database</td></tr>";
                            }
                        } else {
                            echo "<tr><td colspan='5'>Customer ID is not set.</td></tr>";
                        }
                        ?>
                        <?php
...
<table style="width: 100%; border-collapse: collapse; font-size: 14px; table-layout: auto;">
    ...
    <?php endif; ?>
                    ...
                    <div style="display:flex; justify-content: space-between; margin-top: 84px;">

                        <div>
                            <p style="margin-bottom: -5px; text-align: center;">
                                <?php
                                date_default_timezone_set('Asia/Kolkata'); // Set timezone to India
                                echo date('d/m/y H:i:s'); // Display current date and time
                                ?>
                            </p>
                            <hr> <!-- Line after the date -->
                    ...
                    *The Service Provider will not be responsible for any data loss, screen guard, wear and tear, and no
                    ...
                    <div class="col-12 text-right">
                        <button type="button" class="btn btn-primary" onclick="redirectAndPrint()">Print
                            Invoice</button>
                    </div>
                    <!-- CSS for print -->
                    <style>
