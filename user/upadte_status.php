                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input name="repair_cost_estimate" class="form-control"
                                                    value="<?php echo $row["repair_cost_estimate"]; ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="repair_status" class="form-control" id="repairStatus" onchange="changeColor(this)">
                                                    <option value="Pending" <?php if ($row["repair_status"] == 'Pending') echo 'selected'; ?>>Pending</option>
                                                    <option value="In Progress" <?php if ($row["repair_status"] == 'In Progress') echo 'selected'; ?>>In Progress</option>
                                                    <option value="ready" <?php if ($row["repair_status"] == 'ready') echo 'selected'; ?>>Ready For Pickup</option>
                                                    <option value="Completed" <?php if ($row["repair_status"] == 'Completed') echo 'selected'; ?>>Completed</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <script>
                                            ...
                                            // Automatically update color for all dropdowns on page load
                                            document.querySelectorAll('#repairStatus').forEach(select => changeColor(select));
                                        </script>
