...
if (isset($_POST['update'])) {
    ...
    $remaining_payment_mode = isset($_POST['remaining_payment_mode']) ? $_POST['remaining_payment_mode'] : '';
$outdate = $_POST['outdate'];
    ...
    $sql = "
        ...
        SET 
            ...
            heads = '$heads',
            simtray = '$simtray',
            remaining_payment_mode= '$remaining_payment_mode',
            finalcost= '$finalcost',
            outworddatetime='$outdate'
        WHERE id = '$id'";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        // Success message
        echo "<SCRIPT type='text/javascript'>alert('Edited Successfully...!'); window.location.replace('completed.php');</SCRIPT>";
    } else {
