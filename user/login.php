...
if (isset($_POST['login'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM addshop WHERE email='$email'");
...
<head>
    ...
    <link rel="shortcut icon" href="../images/Ganga FB-01.png">
            ...
            <div class="container">
                <div class="loginbox">
                    <div class="login-left bg-white">
                        <img class="img-fluid" src="assets/img/logoo.jpg" alt="Logo">
                    </div>
