            ...
            <div class="content container-fluid">
                <div class="page-header" style="background: aliceblue; padding: 16px 29px; border-radius: 5px;">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title active">Ready For Pickup Customers</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Ready For Pickup Customers</li>
                            </ul>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-center mb-0 datatable" id="tblData">
                                        ...
                                        <tbody>
                                           ...
                                           // Modify the SQL query to filter for 'readyforpickup' repair status
                                           $sql = "SELECT * FROM customers WHERE repair_status = 'ready' AND shop_id = '$shop_id' ORDER BY customers.id DESC";
                                           ...
                                           ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="actions">
                                                                <a href="process_update.php?id=<?= $row["id"] ?>"
                                                                    class="btn btn-md bg-success-light">
                                                        ...
                                                        <td class="text-right">
                                                            <div class="actions">
                                                                <a href="progresstatus.php?id=<?php echo $row["id"]; ?>"
                                                                    class="btn btn-md bg-success-light">
