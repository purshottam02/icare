...
<body>
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title" style="text-align: center; font-size: 40px; font-weight: 600;">Customer Bill</h3>
                            <ul class="breadcrumb">
                ...
                <div class="container">
                    ...
                    ?>
                        ...
                        <tr><td colspan="8" style="    padding: 15px 5px;"><?php echo htmlspecialchars($customer["condition_of_device"]); ?></td></tr>
                    ...
                    *The Service Provider will not be responsible for any data loss, screen guard, wear and tear, and no
                    ...
                    <!-- <div class="col-12 text-center">
                        <button name="mail" type="button" class="btn btn-primary" onclick="redirectAndPrint()">Send
                            Invoice</button>
                    </div> -->
                    <!-- CSS for print -->
                    <style>
                    ...
                    <!-- <script>
                        function redirectAndPrint() {
                            const printWindow = window.open('printt.php?id=<?php echo $id; ?>');
    ...
    <script src="user/assets/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <script src="user/assets/plugins/apexchart/apexcharts.min.js"></script>
    <script src="user/assets/plugins/apexchart/chart-data.js"></script>
